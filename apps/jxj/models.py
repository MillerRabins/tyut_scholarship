...
class xj_study(models.Model):
    ...
    all_score = models.CharField(max_length=10, default=None, verbose_name="综测总分")


    class Meta:
        # ordering = ['study_score','stu_id']
...
class file_up(models.Model):
    ...
    is_update = models.CharField(max_length=2, default=0, verbose_name="is_up")
